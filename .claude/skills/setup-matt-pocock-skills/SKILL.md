...
description: Sets up an `## Agent skills` block in AGENTS.md/CLAUDE.md and `ai-docs/agents/` so the engineering skills know this repo's issue tracker (GitHub or local markdown), triage label vocabulary, and domain doc layout. Run before first use of `to-issues`, `to-prd`, `triage`, `diagnose`, `tdd`, `improve-codebase-architecture`, or `zoom-out` — or if those skills appear to be missing context about the issue tracker, triage labels, or domain docs.
...
- The contents of `ai-docs/agents/issue-tracker.md`, `ai-docs/agents/triage-labels.md`, `ai-docs/agents/domain.md`
...
[one-line summary of the label vocabulary]. See `ai-docs/agents/triage-labels.md`.
